...
<body>
    <form method="POST" action="../src/create_faqs_sp.php" class="help_center">
        <br />
        <div class="form_topic">
            <h3 class="create_form_topic">Enter a New Service Provider FAQ</h3>
        </div><br />
        <div class="message_cage">
            <?php if(isset($_GET['message_spfaq'])) { ?>
                <div class="message"><?php echo $_GET['message_spfaq']; ?></div>
            <?php } ?>
        </div><br />
